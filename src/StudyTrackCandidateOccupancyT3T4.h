#ifndef StudyTrackCandidateccupancyT3T4_h
#define StudyTrackCandidateccupancyT3T4_h
...
class StudyTrackCandidateOccupancyT3T4 : public Study
{
...
public:
    ...
    std::vector<std::vector<std::vector<float>>> EndcapLayerRingTrackCandidateT3T4Occupancy;

    StudyTrackCandidateOccupancyT3T4(const char* studyName);
