#ifndef StudyTrackCandidateccupancy_h
#define StudyTrackCandidateccupancy_h
...
class StudyTrackCandidateOccupancy : public Study
{
...
public:
    ...
    std::vector<std::vector<std::vector<float>>> EndcapLayerRingTrackCandidateOccupancy;

    StudyTrackCandidateOccupancy(const char* studyName);
