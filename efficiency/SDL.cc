...
void SDL::Init(TTree *tree) {
  ...
  qp_sim_eta_branch = 0;
  if (tree->GetBranch("qp_sim_eta") != 0) {
  ...
  tp_simTrkIdx_branch = 0;
  if (tree->GetBranch("tp_simTrkIdx") != 0) {
  ...
  md_sim_pt_branch = 0;
  if (tree->GetBranch("md_sim_pt") != 0) {
    md_sim_pt_branch = tree->GetBranch("md_sim_pt");
    if (md_sim_pt_branch) { md_sim_pt_branch->SetAddress(&md_sim_pt_); }
  }
  sim_hasAll12HitsInBarrel_branch = 0;
  if (tree->GetBranch("sim_hasAll12HitsInBarrel") != 0) {
  ...
  ph2_anchorLayer_branch = 0;
  if (tree->GetBranch("ph2_anchorLayer") != 0) {
  ...
  sim_simHitBoth_branch = 0;
  if (tree->GetBranch("sim_simHitBoth") != 0) {
  ...
  sim_pqpIdx_branch = 0;
  if (tree->GetBranch("sim_pqpIdx") != 0) {
  ...
  sim_simHitDistXyWithHelix_branch = 0;
  if (tree->GetBranch("sim_simHitDistXyWithHelix") != 0) {
  ...
  sim_pqpIdx_isMTVmatch_branch = 0;
  if (tree->GetBranch("sim_pqpIdx_isMTVmatch") != 0) {
  ...
  sim_simHitDrFracWithHelix_branch = 0;
  if (tree->GetBranch("sim_simHitDrFracWithHelix") != 0) {
  ...
  simhit_partnerDetId_branch = 0;
  if (tree->GetBranch("simhit_partnerDetId") != 0) {
  ...
  sim_psgIdx_isMTVmatch_branch = 0;
  if (tree->GetBranch("sim_psgIdx_isMTVmatch") != 0) {
  ...
  pqp_sim_phi_branch = 0;
  if (tree->GetBranch("pqp_sim_phi") != 0) {
  ...
  sg_simTrkIdx_branch = 0;
  if (tree->GetBranch("sg_simTrkIdx") != 0) {
  ...
  sim_qpIdx_isMTVmatch_branch = 0;
  if (tree->GetBranch("sim_qpIdx_isMTVmatch") != 0) {
  ...
  md_simTrkIdx_branch = 0;
  if (tree->GetBranch("md_simTrkIdx") != 0) {
